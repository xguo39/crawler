...
public interface CrawlerStoreService {
	...
	void storeUrlAsVisited(String tableName, String url, String storeOption) throws SQLException;
	Optional<String[]> getUrlAndStoreOptionWithRecordID(String tableName, int index) throws SQLException, IOException;
